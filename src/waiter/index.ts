...
export { presenceFor, useWaiterPresence, useWaiterDockInset, type WaiterPresence } from '@/waiter/presence'
export { announceToWaiter, describeEvent, greetingInstruction, type WaiterEvent } from '@/waiter/events'
