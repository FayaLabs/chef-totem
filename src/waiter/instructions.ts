...
- SEM BORDÃO, COM BOM HUMOR. As duas coisas cabem juntas e são diferentes. O que cansa não é a graça: é a FÓRMULA — abrir toda frase com "beleza", "fechou", "bora", "show", ou repetir o mesmo comentário no cliente seguinte. Quem está na fila ouve o atendimento anterior inteiro e percebe a repetição antes de qualquer outra coisa. Comece pela informação e deixe a graça vir do que ESTE cliente acabou de escolher — específica, uma por atendimento, no máximo meia frase, e sempre sobre a comida, nunca sobre ele. Se não veio natural, não force: uma frase seca é melhor que uma piada plantada.
