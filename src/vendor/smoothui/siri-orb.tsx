// ---------------------------------------------------------------------------
// Vendorizado de SmoothUI (https://smoothui.dev), MIT — Eduardo Calvo.
//
// Copiado e não instalado porque é assim que o projeto distribui: a CLI dele
// cola o arquivo no seu repo, como shadcn. Vive em src/vendor/ para que fique
// óbvio que este código não é nosso e que editá-lo custa o próximo update.
//
// A ÚNICA alteração em relação ao original é o import de `cn`, que apontava
// para `@/lib/utils` (convenção do shadcn, que este app não usa).
// ---------------------------------------------------------------------------

"use client";

import { cn } from "@/vendor/smoothui/cn";
import {
  type MotionStyle,
  motion,
